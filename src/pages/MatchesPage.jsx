        ...
        <div className='matches__info'>
          <div className='matches__info-btns'>
            <span
              ...
              className={current ? 'matches__info-btn-active matches__info-btn' : 'matches__info-btn'}
            >
              Предстоящие
            </span>
            <span
              onClick={() => setCurrent(false)}
              className={!current ? 'matches__info-btn matches__info-btn-active' : 'matches__info-btn'}
            >
              Прошедшие
            </span>
          </div>
          <div className='matches__info-select'>
            <ul className='matches__info-select-items'>
              <li className='matches__info-select-item'>
                ...
                <img className='matches__info-select-item-img' src={dotSvg} alt="dotSvg" />
                {/* <ul>
                <li>Все турниры</li>
